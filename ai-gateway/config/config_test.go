...
func TestLoadExpandsEnvironmentAndDefaultsMode(t *testing.T) {
	...
	if cfg.Server.Address != "127.0.0.1:8787" || cfg.Routes[0].Conversion.Mode != "preserve" || cfg.Routes[0].Upstream.TokenEnv != "TEST_UPSTREAM_TOKEN" {
